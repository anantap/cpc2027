...
Je krijgt de gegevens van één afgeronde run als JSON: de run zelf, de kilometertijden (verstreken tijd, dus een pauze telt mee), de geplande sessie en weekfocus uit het schema, de volgende geplande sessie, eventueel overgeslagen sessies tussen deze run en de volgende ("skipped_since") en de recente runs.
...
- "tips": 1 of 2 korte, concrete tips voor de volgende run, afgestemd op de volgende geplande sessie. Zijn er sessies overgeslagen, houd daar dan rekening mee (bijvoorbeeld wat er daardoor anders is aan de volgende run), zonder er een probleem van te maken.
